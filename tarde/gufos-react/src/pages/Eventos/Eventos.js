...
class Eventos extends Component{
    ...
    constructor(){
        ...
        CadastrarEventos(){
          Axios.post('http://192.168.7.85:5000/api/categorias',{
              titulo:this.state.Titulo,
              dataEvento:this.state.dataEvento,
              ativo:this.state.ativo,
              idCategoriaNavigation:this.state.idCategoriaNavigation.nome
          })
            .then(data =>{
                if (data.status === 200){
  ...
  <main className="conteudoPrincipal">
    ...
    <Titulo titulo="Eventos"/>
      ...
      <div className="container" id="conteudoPrincipal-cadastro">
        ...
        <button className="conteudoPrincipal-btn conteudoPrincipal-btn-cadastro" value="submit">Cadastrar</button>
      </div>
    </section>
  </main>
